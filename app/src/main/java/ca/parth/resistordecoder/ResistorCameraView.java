...
public class ResistorCameraView extends SurfaceView implements Camera.PreviewCallback, SurfaceHolder.Callback {
    ...
    protected class CvCameraViewListenerAdapter implements NativeCameraView.CvCameraViewListener2 {
        ...
        @Override
        public Mat onCameraFrame(NativeCameraView.CvCameraViewFrame inputFrame) {
             Mat result = null;
    ...
    public ResistorCameraView(Context context, AttributeSet attrs) {
        ...
        TypedArray styledAttrs = this.getContext().obtainStyledAttributes(attrs, org.opencv.R.styleable.CameraBridgeViewBase);
